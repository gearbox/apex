...
class MediaHashLedger:
    ...
    async def register_upload(
        self, upload: UserImage, hash_set: HashSet, *, job_id: object | None = None
    ) -> None:
    ...
    @staticmethod
    def _media_type(media_format: str) -> str:
        try:
            return "video" if MediaFormat(media_format).is_video else "image"
