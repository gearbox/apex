...
async def test_get_first_outputs_for_jobs_returns_lowest_index(
    ...
    job = await make_job()
    out0 = await _make_output_row(storage_repo, user_id=job.user_id, job_id=job.id, output_index=0)
    await _make_output_row(storage_repo, user_id=job.user_id, job_id=job.id, output_index=1)
    await _make_output_row(storage_repo, user_id=job.user_id, job_id=job.id, output_index=2)
