...
async def test_create_user_image(
...
async def test_get_user_image_found(
    storage_repo: StorageRepository, make_user_image
) -> None:
...
async def test_get_user_image_by_key(
    storage_repo: StorageRepository, make_user
) -> None:
...
async def test_list_user_images_offset_past_end(
    storage_repo: StorageRepository, make_user
) -> None:
...
async def test_delete_user_image(
    storage_repo: StorageRepository, make_user_image
) -> None:
...
async def test_get_expired_images(
    storage_repo: StorageRepository, make_user
) -> None:
...
async def test_list_user_jobs_offset_past_end(
    storage_repo: StorageRepository, make_user
) -> None:
...
async def test_create_output_invalid_job_raises(
    storage_repo: StorageRepository, make_user
) -> None:
...
async def test_get_output_found(
    storage_repo: StorageRepository, make_user, make_job
) -> None:
...
async def test_list_job_outputs(
    storage_repo: StorageRepository, make_user, make_job
) -> None:
...
async def test_list_job_outputs_no_outputs(
    storage_repo: StorageRepository, make_job
) -> None:
...
async def test_delete_outputs_batch(
    storage_repo: StorageRepository, make_user, make_job
) -> None:
...
async def test_get_expired_outputs(
    storage_repo: StorageRepository, make_user, make_job
) -> None:
...
async def test_get_user_storage_stats_empty(
    storage_repo: StorageRepository, make_user
) -> None:
